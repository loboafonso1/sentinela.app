...
const BottomNav = () => {
  ...
  // Não exibir BottomNav em telas de entrada/onboarding/login, investigação ou análise
  const hideNavPaths = ["/", "/login", "/ia-selection", "/auth/callback", "/investigacao", "/analise-padroes", "/resultado-analise"];
