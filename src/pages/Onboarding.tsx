        ...
        >
          ...
          <div className="px-6 pt-3 pb-6">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-purple-500 to-fuchsia-500 text-white font-semibold rounded-2xl py-4 hover:opacity-95"
            >
              Começar agora
            </Button>
            <div className="mt-3 grid grid-cols-2 gap-3">
              <Button
                ...
                onClick={() => navigate("/estudos")}
                variant="outline"
                className="rounded-2xl border-white/30 text-white hover:bg-white/10 px-5 py-3 inline-flex items-center justify-center gap-2 leading-tight"
              >
